      ...
      <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
        ...
        <form className='grid p-4 gap-2 overflow-y-scroll h-full pb-5' onSubmit={handleSubmit}>
          ...
          <div className='flex gap-3'>
            <button className='px-3 py-2 bg-red-600 text-white hover:bg-red-700'>Update Product</button>

            <button
              type="button"
              className="px-3 py-2 bg-red-700 text-white hover:bg-red-800"
              onClick={handleDeleteProduct}
            >
              <MdDelete className='inline-block mr-1' /> Delete Product
            </button>
          </div>
        </form>
      </div>
