  ...
  return (
    <>
       <div className="sticky inset-x-0 top-0 z-50 bg-[#121212] text-white">
        <header className=" w-full border-b border-white bg-[#121212] px-4">
          <nav className="mx-auto flex max-w-7xl items-center py-2">
            ...
            <div className="relative mx-auto hidden w-full max-w-md overflow-hidden sm:block"><input
              ...
              placeholder="Search" /><span
                className="absolute left-2.5 top-1/2 inline-block -translate-y-1/2">
                {/* svg */}
                <svg
              ...
              </span></div><button className="ml-auto sm:hidden">
              {/* svg */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            </button><button className="group peer ml-4 flex w-6 shrink-0 flex-wrap gap-y-1.5 sm:hidden"><span
            ...
            <div
              ...
              <div
                ...
                </span><button className="inline-block w-8">
                  {/* svg */}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
              ...
              <div className="mb-8 mt-auto flex w-full flex-wrap gap-4 px-4 sm:mb-0 sm:mt-0 sm:items-center sm:px-0">
                <button className="w-full bg-[#383737] px-3 py-2 hover:bg-[#4f4e4e] sm:w-auto sm:bg-transparent">Log
                  in</button><button
                    className="mr-1 w-full bg-[#ae7aff] px-3 py-2 text-center font-bold text-black shadow-[5px_5px_0px_0px_#4f4e4e] transition-all duration-150 ease-in-out active:translate-x-[5px] active:translate-y-[5px] active:shadow-[0px_0px_0px_0px_#4f4e4e] sm:w-auto">Sign
                  up</button></div>
            </div>
          </nav>
        </header>
